...
\documentclass[
    % Debugging Settings
    PrintFilePath   = true,            % print tex file path for each page
    % Layout Settings
    ...
    % Title
    % Title           = 高性能的可验证隐匿查询及其在区块链中的应用,
    % TitleEng        = {{Effective Verifiable PIR and Its Applications in Blockchain}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{高性能的可验证隐匿查询}{及其在区块链中的应用}
\titleengtwolines{Effective Verifiable PIR}{and Its Applications in Blockchain}
